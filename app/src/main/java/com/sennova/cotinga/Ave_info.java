...
public class Ave_info extends AppCompatActivity {
   ...
   @Override
    ...
    private File getFile(){
        File folder = new File(Environment.getExternalStorageDirectory().toString()+"/Cotinga");
        //folder.mkdirs();
        if(!folder.exists()){
            folder.mkdirs();
        }

        File image_file = new File(folder,nombreave+".jpg");
        return image_file;
    }
  ...
  @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        if(resultCode == RESULT_OK && requestCode == PICK_IMAGE) {
            ...
            String path= "sdcard/Cotinga/"+nombreave+".jpg";
            foto_gallery.setImageDrawable(Drawable.createFromPath(path));
    ...
    public void onBackPressed() {
        ...
        explicit_intent = new Intent(Ave_info.this,Filtro.class);
